  ...
  const handlePost = async () => {
    if (message && picture) {
      ...
      await axios
        ...
        .then((res) => {
          ...
          axios({
            ...
            data: { posterId: userData._id, message, picture },
          })
            .then((res) => {
              console.log(res.data);
              dispatch(getPosts());
      ...
      await axios({
        method: "post",
        url: `http://localhost:4000/api/post/`,
        data: { posterId: userData._id, message, video },
      })
        .then((res) => {
          console.log(res.data);
          dispatch(getPosts());
      ...
      await axios({
        method: "post",
        url: `http://localhost:4000/api/post/`,
        data: { posterId: userData._id, message },
      })
        .then((res) => {
          console.log(res.data);
          dispatch(getPosts());
      ...
      alert("vous ne pouvez envoyer une video et une image");
    } else {
